...
- [ ] 2.1 Write a failing test for a new `cliconfig.PromptValue(in
...
- [ ] 2.2 Write a failing test for a new `cliconfig.PromptSecret` that reads
...
- [ ] 2.3 Write a failing test for a new `cliconfig.PromptPersistence(in
...
- [ ] 2.4 Write a failing test for a new `cliconfig.PromptConfig(in
